...
public class MainPage {
    ...
    private static final String MAIN_URL = "https://api.icndb.com";
    private static final String FIRST_LAST_NAME = "jokes/random?firstName=%s&lastName=%s"; //Изменение имени главного героя
    private static final String RANDOM_JOKE = "jokes/random"; //Получение случайной шутки
    private static final String MULTIPLE_RANDOM_JOKE = "jokes/random/%d"; // Получение нескольких случайных шуток
    private static final String SPECIFIC_JOKE = "jokes/%d"; // Получение определенной шутки
    private static final String NUMBER_OF_JOKES = "jokes/count"; //Получение количества анекдотов
